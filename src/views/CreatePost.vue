  ...
  <div class="create-post">
    ...
    <div class="container">
      <div :class="{ invisible: !error }" class="error-message">
        <p><span>Error:</span>{{ this.error }}</p>
      </div>
      <div class="blog-info">
  ...
  methods: {
    ...
    imageHandler(file, Editor, cursorLocation, resetUpLoader) {
      ...
      docRef.put(file).on(
        'state_changes',
        (snapshot) => {
          console.log('The snapshots: ', snapshot);
        },
        (err) => {
          console.log(err);
        },
      ...
      if (this.blogTitle.length !== 0 && this.blogHTML.length !== 0) {
        if (this.file == true) {
          ...
          const docRef = storageRef.child(
            `documents/BlogCoverPhotos/${this.$storage.state.blogPhotoName}`
          );
          docRef.put(this.file).on(
            ...
            async () => {
              ...
              await dataBase.set({
                ...
                blogCoverName: this.blogCoverPhotoName,
